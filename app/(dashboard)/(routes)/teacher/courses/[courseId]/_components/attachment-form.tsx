...
const AttachmentForm = ({
    ...
    console.log('Rendering AttachmentForm with initialData:', initialData); // Add this log statement
                                ...
                                <div className="space-y-2">
                                    {initialData.attachments.map((attachment) => (
                                        <div 
                                            ...
                                            p-3 w-full bg-sky-100 border-sky-200 
            ...
            {isEditing && (
                <div>
                    ...
                    <div className="text-xs text-muted-foreground mt-4">
                        Add anything that will help students to complete your course.
